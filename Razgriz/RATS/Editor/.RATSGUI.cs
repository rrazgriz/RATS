// RATS - Raz's Animator Tweaks Suite
...
namespace Razgriz.RATS
{
	public class RATSGUI : EditorWindow
	{
        ...
        private static List<AnimationClip> animationClips;
        private ArrayList pathsKeys;
        private Hashtable paths;

        static Dictionary<string, string> tempPathOverrides;
		...
		void OnGUI()
		{
			...
			switch(tab)
			{
				...
				case Tabs.AnimEditor:
					...
					if (animationClips != null) if (animationClips.Count > 0) {
